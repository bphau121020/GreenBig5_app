...
import '../model/questionModel1.dart';
import 'package:timezone/timezone.dart' as tz;
import 'package:timezone/data/latest.dart' as tz;
import 'package:flutter_local_notifications/flutter_local_notifications.dart';
import 'package:google_fonts/google_fonts.dart';
import 'package:hexcolor/hexcolor.dart';
import "../Network/answerNetwork.dart";
import '../Network/questionsNetwork.dart';
                        ...
                        if(snapshot.hasError) {
                          ...
                          if(snapshot.data.questions.length==null){
                            ...
                            children: [
                              ...
                              questionsView(context,snapshot,snapshot.data.questions.length),
    ...
    if(snapshot.hasData){
      return Container(
        ...
        child: Column(
          mainAxisAlignment: MainAxisAlignment.spaceBetween,
          children: [
            AnswerCard(context,snapshot,"Yes",lenght),
            AnswerCard(context,snapshot, "No",lenght),
          ],
        ),
      );
    }

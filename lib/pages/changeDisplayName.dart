...
import '../Network/changeDisplayNameNetwork.dart';
...
class _changeDisplayNameState extends State<changeDisplayName> {
  ...
  Widget Notificationinput(BuildContext context){
    return Container(
      ...
      child: Column(
        children: [
          Text("You can choose your name a username on Green Big 5. If you do, people will be able to find you",
          style: GoogleFonts.roboto(
            textStyle: TextStyle(
              fontSize: 14,
  ...
  Future submitChangeDisplay(){
    _phoneNumber.then((value){
      ...
      var doneWork=changeDisplayNameNetwork().changeDisplayNameMethod(displayName.text, value);
      doneWork.then((value){
